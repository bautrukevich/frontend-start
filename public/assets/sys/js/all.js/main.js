...
(function ($) {
  ...
  $.fn.krutilka = function (o) {
    var options = {
      size: 14, // Ширина и высота блока с крутилкой
      petals: 9, // Сколько лепестков у крутилки
      ...
      time: 800, // Время прохода круга в миллисекундах
      color: '#fff', // Цвет лепестков, можно RGBA
